...
class SP1PluginInfoOverview extends MovieClip
{
...
var typeEntry
var VPinMax
		public function SP1PluginInfoOverview(){	
				_x = dat.xPos
				_y = dat.yPos
				...
				panel = this
				panDat = o.lib.PLib.get(dia.module.id) 
			...
			public function makeOverlay(){
				...
				typeEntry.size = 10
							...
							for (var i=0; i < panDat.plugin.length; i++){
								...
								if(o.scan.refMod[dia.module.id].plug[panDat.plugin[i].id]){installed.push(panDat.plugin[i])}

...
class core.panel.inspect.infoBody extends MovieClip {
...
var display
	...
	function infoBody(){
		...
		dataO.push({cmd:{fn:"", out:"sceneInfoActorScale"}, bt:{b:"omu_bodyscalestage"}, hud:{sy:"oconMiniCircle", panel:"_infoActorScale", mode:"1"}, tx:{desc:o.cfg.lang.currentScale.toUpperCase()}})

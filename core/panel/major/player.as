...
class core.panel.major.player extends MovieClip {
...
var display
		...
		brass = new core.panel.major.brass.typeA(o, this, posO, o.cfg.lang.player, "")
		posO.vStart = posO.v
		
		var dataO = []
		
		dataO.push({cmd:{fn:"esc"}, bt:{sy:"oconMiniCircle", b:"omu_backmenu"}, tx:{desc:o.cfg.lang.back.toUpperCase()}}) 
		dataO.push({cmd:{fn:"adv", out:"majorPlayerSymbol"}, hud:{panel:"_majorIniText"}, bt:{sy:"oconMiniCircle", b:"omu_"+o.cfg.config.playerSymbolString}, tx:{desc:o.cfg.lang.playerSymbol.toUpperCase(), ini:o.cfg.lang.playerSymbolEx}})

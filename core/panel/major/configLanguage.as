...
class core.panel.major.configLanguage extends MovieClip {
...
var display
		...
		brass = new core.panel.major.brass.typeA(o, this, posO, o.cfg.lang.language+" | "+o.cfg.lang.config, "")
		posO.vStart = posO.v
		
		var dataO = []

		dataO.push({cmd:{fn:"esc"}, bt:{sy:"oconMiniCircle", b:"omu_backmenu"}, tx:{desc:o.cfg.lang.back.toUpperCase()}}) 
		dataO.push({cmd:{fn:"use"}, bool:{prop:"autoCodepage", fn:"tog"}, hud:{panel:"_majorIniText"}, bt:{sy:"oconMiniCircleBool", b:"omu_autofont"}, tx:{desc:o.cfg.lang.autoCodepageTog.toUpperCase(), ini:o.cfg.lang.autoCodepageTogEx}})
		dataO.push({cmd:{fn:"use"}, bool:{prop:"internationalFont", fn:"togFont"}, hud:{panel:"_majorIniText"}, bt:{sy:"oconMiniCircleBool", b:"omu_idkchinese"}, tx:{desc:o.cfg.lang.internationalFontTog.toUpperCase(), ini:o.cfg.lang.internationalFontTogEx}})
		
		dataO.push({cmd:{fn:"use"}, bool:{prop:"internationalFontSansSerif", fn:"togFont"}, hud:{panel:"_majorIniText"}, bt:{sy:"oconMiniCircleBool", b:"omu_serif"}, tx:{desc:o.cfg.lang.internationalFontStyleTog.toUpperCase(), ini:o.cfg.lang.internationalFontStyleTogEx}})
		dataO.push({cmd:{fn:"special", out:"RefreshCodepage"}, hud:{panel:"_majorIniText"}, bt:{sy:"oconMiniCircle", b:"omu_utf"}, tx:{desc:o.cfg.lang.refreshCodePage.toUpperCase(), ini:o.cfg.lang.refreshCodePageEx+" "+o.cfg.config.codepage}})
	...
	o.skyAll("0SA_Special", buildO.buttons[buildO.point].dataO.cmd.out)
	}

...
class core.panel.major.ScSettingsSex extends MovieClip {
...
var display
		...
		brass = new core.panel.major.brass.typeA(o, this, posO, o.cfg.lang.sex.toUpperCase()+" | "+o.cfg.lang.sceneSettings+" | "+o.cfg.lang.config.toUpperCase(), "")
		posO.vStart = posO.v
		
		var dataO = []
		
		dataO.push({cmd:{fn:"esc"}, bt:{sy:"oconMiniCircle", b:"omu_backmenu"}, tx:{desc:o.cfg.lang.back.toUpperCase()}}) 
		dataO.push({cmd:{fn:"use"}, bool:{prop:"MyEquip", fn:"tog"}, hud:{panel:"_majorIniText"}, bt:{sy:"oconMiniCircleBool", b:"omu_wand"}, tx:{desc:o.cfg.lang.fantastical, ini:o.cfg.lang.flagsDisclaimer}})
		dataO.push({cmd:{fn:"use"}, bool:{prop:"MyEquip", fn:"tog"}, hud:{panel:"_majorIniText"}, bt:{sy:"oconMiniCircleBool", b:"omu_hand"}, tx:{desc:o.cfg.lang.rough, ini:o.cfg.lang.flagsDisclaimer}})

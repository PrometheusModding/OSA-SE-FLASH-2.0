...
class core.panel.major.settingsData extends MovieClip {
...
var display
		...
		brass = new core.panel.major.brass.typeA(o, this, posO, o.cfg.lang.saveLoadSettings+" | "+o.cfg.lang.config.toUpperCase(), "")
		posO.vStart = posO.v
		
		var dataO = []
		
		dataO.push({cmd:{fn:"esc"}, bt:{sy:"oconMiniCircle", b:"omu_backmenu"}, tx:{desc:o.cfg.lang.back.toUpperCase()}}) 
		dataO.push({cmd:{fn:"adv", out:"majorSettingsDataSlots", loadsave:"0"}, bt:{sy:"oconMiniCircle", b:"omu_floppydiskload"}, tx:{desc:o.cfg.lang.loadSettings.toUpperCase()}})
		dataO.push({cmd:{fn:"adv", out:"majorSettingsDataSlots", loadsave:"1"}, bt:{sy:"oconMiniCircle", b:"omu_floppydisksave"}, tx:{desc:o.cfg.lang.saveSettings.toUpperCase()}})

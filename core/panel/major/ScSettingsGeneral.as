...
class core.panel.major.ScSettingsGeneral extends MovieClip {
...
var display
		...
		brass = new core.panel.major.brass.typeA(o, this, posO, o.cfg.lang.general.toUpperCase()+" | "+o.cfg.lang.sceneSettings+" | "+o.cfg.lang.config.toUpperCase(), "")
		posO.vStart = posO.v
		
		var dataO = []
		
		dataO.push({cmd:{fn:"esc"}, bt:{sy:"oconMiniCircle", b:"omu_backmenu"}, tx:{desc:o.cfg.lang.back.toUpperCase()}}) 
		dataO.push({cmd:{fn:"use"}, bool:{prop:"fGenModernObjects", fn:"tog"}, hud:{panel:"_majorIniText"}, bt:{sy:"oconMiniCircleBool", b:"omu_ophone"}, tx:{desc:o.cfg.lang.modernObjects, ini:o.cfg.lang.flagsDisclaimer}})
		
		if(o.cfg.config.purityMode == 0){
		dataO.push({cmd:{fn:"use"}, bool:{prop:"fGenPillage", fn:"tog"}, hud:{panel:"_majorIniText"}, bt:{sy:"oconMiniCircleBool", b:"omu_pillage"}, tx:{desc:o.cfg.lang.pillage, ini:o.cfg.lang.flagsDisclaimer}})
		dataO.push({cmd:{fn:"use"}, bool:{prop:"fGenHypertaboo", fn:"tog"}, hud:{panel:"_majorIniText"}, bt:{sy:"oconMiniCircleBool", b:"omu_jail"}, tx:{desc:o.cfg.lang.hyperTaboo, ini:o.cfg.lang.flagsDisclaimer}})
		}

...
class core.panel.major.configMyOSA extends MovieClip {
...
var display
		...
		brass = new core.panel.major.brass.typeA(o, this, posO, o.cfg.lang.myOSA+" | "+o.cfg.lang.config.toUpperCase(), "")
		posO.vStart = posO.v
		
		var dataO = []
		
		dataO.push({cmd:{fn:"esc"}, bt:{sy:"oconMiniCircle", b:"omu_backmenu"}, tx:{desc:o.cfg.lang.back.toUpperCase()}}) 
		dataO.push({cmd:{fn:"use"}, bool:{prop:"MyEquip", fn:"tog"}, hud:{panel:"_majorIniText"}, bt:{sy:"oconMiniCircleBool", b:"omu_shirt"}, tx:{desc:o.cfg.lang.MyEquipTog, ini:o.cfg.lang.MyEquipTogEx}})
		dataO.push({cmd:{fn:"use"}, bool:{prop:"MyAnim", fn:"tog"}, hud:{panel:"_majorIniText"}, bt:{sy:"oconMiniCircleBool", b:"omu_serif"}, tx:{desc:o.cfg.lang.MyAnim, ini:o.cfg.lang.MyAnimTogEx}})

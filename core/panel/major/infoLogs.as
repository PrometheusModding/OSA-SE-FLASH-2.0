...
class core.panel.major.infoLogs extends MovieClip {
...
var helper
		...
		dataO.push({cmd:{fn:"esc"}, bt:{sy:"oconMiniCircle", b:"omu_backmenu"}, noHelper:true, tx:{desc:o.cfg.lang.back.toUpperCase()}}) 
		dataO.push({cmd:{fn:"report", out:"1"}, hud:{panel:"_majorLongText"}, bt:{sy:"oconMiniCircle", b:"omu_virussky"}, noHelper:true, tx:{desc:o.cfg.lang.systemReport.toUpperCase(), long:o.log.sys}})
		dataO.push({cmd:{fn:"printLog", log:"full"}, hud:{panel:"_majorLongText"}, bt:{sy:"oconMiniCircle", b:"omu_logall"}, tx:{desc:o.cfg.lang.full+" "+o.cfg.lang.log.toUpperCase(), isLog:true, long:o.log.full}})
		dataO.push({cmd:{fn:"printLog", log:"run"}, hud:{panel:"_majorLongText"}, bt:{sy:"oconMiniCircle", b:"omu_logrun"}, tx:{desc:o.cfg.lang.process+" "+o.cfg.lang.log.toUpperCase(), isLog:true, long:o.log.run}})
		dataO.push({cmd:{fn:"printLog", log:"boot"}, hud:{panel:"_majorLongText"}, bt:{sy:"oconMiniCircle", b:"omu_logboot"}, tx:{desc:o.cfg.lang.bootup+" "+o.cfg.lang.log.toUpperCase(), isLog:true, long:o.log.boot}})
		dataO.push({cmd:{fn:"printLog", log:"stg"}, hud:{panel:"_majorLongText"}, bt:{sy:"oconMiniCircle", b:"omu_logstage"}, tx:{desc:o.cfg.lang.stage+" "+o.cfg.lang.log.toUpperCase(), isLog:true, long:o.log.stg}})
		dataO.push({cmd:{fn:"printLog", log:"trg"}, hud:{panel:"_majorLongText"}, bt:{sy:"oconMiniCircle", b:"omu_logtarget"}, tx:{desc:o.cfg.lang.targeting+" "+o.cfg.lang.log.toUpperCase(), isLog:true, long:o.log.trg}})
		dataO.push({cmd:{fn:"printLog", log:"hot"}, hud:{panel:"_majorLongText"}, bt:{sy:"oconMiniCircle", b:"omu_loghot"}, tx:{desc:o.cfg.lang.hot+" "+o.cfg.lang.log.toUpperCase(), isLog:true, long:o.log.hot}})
		dataO.push({cmd:{fn:"printLog", log:"hot"}, hud:{panel:"_majorLongText"}, bt:{sy:"oconMiniCircle", b:"omu_logwar"}, tx:{desc:o.cfg.lang.warning+" "+o.cfg.lang.log.toUpperCase(), isLog:true, long:o.log.war}})

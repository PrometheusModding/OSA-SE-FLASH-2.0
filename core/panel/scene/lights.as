...
class core.panel.scene.lights extends MovieClip {
...
var display
		...
		amu.brass = new core.panel.major.brass.typeA(o, amu, amu.posO, o.cfg.lang.lights.toUpperCase(), "")
		...
		amu.dataO.push({cmd:{fn:"light", out:"FaceBright"}, bt:{b:"omu_lightbulb"}, hud:{sy:"oconMiniCircle"}, tx:{desc:core.util.func.textinsert(o.cfg.lang.brightFaceLight, actra.name).toUpperCase()}})
		amu.dataO.push({cmd:{fn:"light", out:"FaceDim"}, bt:{b:"omu_lightbulbsmall"}, hud:{sy:"oconMiniCircle"}, tx:{desc:core.util.func.textinsert(o.cfg.lang.dimFaceLight, actra.name).toUpperCase()}})
		amu.dataO.push({cmd:{fn:"light", out:"AssBright"}, bt:{b:"omu_lightbulbdown"}, hud:{sy:"oconMiniCircle"}, tx:{desc:core.util.func.textinsert(o.cfg.lang.brightRearLight, actra.name).toUpperCase()}})
		amu.dataO.push({cmd:{fn:"light", out:"AssDim"}, bt:{b:"omu_lightbulbsmalldown"}, hud:{sy:"oconMiniCircle"}, tx:{desc:core.util.func.textinsert(o.cfg.lang.dimRearLight, actra.name).toUpperCase()}})
		amu.dataO.push({cmd:{fn:"light", out:"Remove"}, bt:{b:"omu_lightbulbx"}, hud:{sy:"oconMiniCircle"}, tx:{desc:core.util.func.textinsert(o.cfg.lang.removeLights, actra.name).toUpperCase()}})
	...
	public function light(){
			...
			m.dia.actra[m.tabActra].lightFx(actraMenu[cur].buildO.buttons[actraMenu[cur].buildO.point].dataO.cmd.out)
	}

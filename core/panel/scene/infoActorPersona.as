...
class core.panel.scene.infoActorPersona extends MovieClip {
...
var display
		...
		amu.brass = new core.panel.major.brass.typeA(o, amu, amu.posO, o.cfg.lang.persona+" | "+o.cfg.lang.character+" | "+o.cfg.lang.info.toUpperCase(), "")
		...
		amu.dataO.push({cmd:{fn:"", out:""}, bt:{b:"omu_personavoice"}, hud:{sy:"oconMiniCircle", panel:"_InfoActorPerIntSound"}, tx:{desc:o.cfg.lang.sounds.toUpperCase()+" | "+o.cfg.lang.intimate.toUpperCase()}})
		amu.dataO.push({cmd:{fn:"", out:""}, bt:{b:"omu_personaexpression"}, hud:{sy:"oconMiniCircle", panel:"_InfoActorPerIntClass"}, tx:{desc:o.cfg.lang.personaClass.toUpperCase()+" | "+o.cfg.lang.intimate.toUpperCase()}})
		amu.dataO.push({cmd:{fn:"", out:""}, bt:{b:"omu_personareaction"}, hud:{sy:"oconMiniCircle", panel:"_InfoActorPerIntReaction"}, tx:{desc:o.cfg.lang.reaction.toUpperCase()+" | "+o.cfg.lang.intimate.toUpperCase()}})

...
class core.panel.scene._infoModule extends MovieClip
{
...
var pandect
			...
			function makeOverlay(){
				...
				cur = this.attachMovie("genericText", "nameVaR", this.getNextHighestDepth(), {_x:horizon, _y:yLoc}).val	
				cur.htmlText = m.dia.module.name
				cur.setTextFormat(type);
				cur.autoSize = "right";
			...
			public function makeValues(){
				...
				panel.nameVal.htmlText = m.dia.module.name
				panel.subTitleVal.htmlText = o.lib.PLib.get(m.dia.module.id).subtitle
				panel.sloganVal.htmlText = o.lib.PLib.get(m.dia.module.id).slogan
				panel.modidVal.htmlText = m.dia.module.id
				panel.creatorVal.htmlText = "By "+m.dia.module.creator
